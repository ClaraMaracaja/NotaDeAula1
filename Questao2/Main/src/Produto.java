...
public class Produto {
    ...
    public void Pagamento() {
        ...
        switch (pagamento) {
            case 1:
                System.out.println("Pagamento de Pix bem sucedido");
                System.out.println("valor de desconto foi de " + valor * 0.05);
                break;
            case 2:
                System.out.println("Pagamento de Cartão de Débito bem sucedido");
                System.out.println("valor de desconto foi de " + valor * 0.05);
                break;
            case 3:
                System.out.println("Pagamento em Transferência bem sucedido");
                System.out.println("valor de desconto foi de " + valor * 0.05);
                break;
            case 4:
                ...
                System.out.println("Pagamento em Espécie bem sucedido");
                System.out.println("Valor de desconto foi de " + (valor * 0.05));
                break;
            case 5:
                ...
                if (parcelar == 's' || parcelar == 'S') {
                    ...
                    System.out.println("Pagamento de credito bem sucedido");
                    break;
                }
        }
    }
